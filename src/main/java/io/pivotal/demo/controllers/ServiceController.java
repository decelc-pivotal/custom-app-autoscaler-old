...
import io.pivotal.demo.domain.ServiceBindInfo;
import io.pivotal.demo.domain.ServiceBinding;
import io.pivotal.demo.domain.ServiceInstance;
import io.pivotal.demo.domain.ServiceInstanceBindInfo;
...
public class ServiceController {
	...
	public JSONObject getSIInfo(@PathVariable String instance_id, HttpServletResponse response) throws IOException {
		log.debug("getSIInfo() instance_id=" + instance_id);
	...
	public JSONObject putSIInfo(@PathVariable String instance_id, @RequestBody ServiceInstanceBindInfo serviceBindInfo,
		...
		log.debug("putSIInfo() instance_id=" + instance_id);
		log.debug("putSIInfo() getOrganization_guid=" + serviceBindInfo.getOrganization_guid());
		log.debug("putSIInfo() getSpace_guid=" + serviceBindInfo.getSpace_guid());
		log.debug("putSIInfo() getService_id=" + serviceBindInfo.getService_id());
		log.debug("putSIInfo() getPlan_id=" + serviceBindInfo.getPlan_id());
	...
	public JSONObject deleteSIInfo(@PathVariable String instance_id, @RequestParam("service_id") String service_id,
		...
		log.debug("putSIInfo() instance_id=" + instance_id);
		log.debug("putSIInfo() service_id=" + service_id);
		log.debug("putSIInfo() plan_id=" + plan_id);
	...
	public JSONObject putSIBInfo(@PathVariable String instance_id, @PathVariable String binding_id,
		...
		log.debug("putSIBInfo() instance_id=" + instance_id);
		log.debug("putSIBInfo() getService_id=" + serviceBindInfo.getService_id());
		log.debug("putSIBInfo() plan_id=" + serviceBindInfo.getPlan_id());

		log.debug("putSIInfo() getBindResource.getApp_guid=" + serviceBindInfo.getBind_resource().getApp_guid());
	...
	public JSONObject deleteSIBInfo(@PathVariable String instance_id, @PathVariable String binding_id,
			...
			HttpServletResponse response) throws IOException {
		log.debug("deleteSIBInfo() instance_id=" + instance_id);
		log.debug("deleteSIBInfo() binding_id=" + binding_id);
		log.debug("deleteSIBInfo() service_id=" + service_id);
		log.debug("deleteSIBInfo() plan_id=" + plan_id);
